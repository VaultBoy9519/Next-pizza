...
exports.useFilters = function () {
    ...
    //Фильтр цен
    var _g = react_1.useState({ priceFrom: Number(searchParams.get('priceFrom')) || undefined, priceTo: Number(searchParams.get('priceTo') || undefined) }), prices = _g[0], setPrices = _g[1];
