...
exports.useFilterIngredients = function () {
    var _a = react_1.useState(true), loading = _a[0], setLoading = _a[1];
    var _b = react_1.useState([]), ingredients = _b[0], setIngredients = _b[1];
    react_1.useEffect(function () {
        function getIngredients() {
            return __awaiter(this, void 0, void 0, function () {
                var ingredients_1, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            setLoading(true);
                            return [4 /*yield*/, api_client_1.Api.ingredients.getAll()];
                        case 1:
                            ingredients_1 = _a.sent();
                            setIngredients(ingredients_1);
                            setLoading(false);
                            return [3 /*break*/, 3];
                        case 2:
                            e_1 = _a.sent();
