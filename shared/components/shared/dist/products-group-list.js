...
exports.ProductsGroupList = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: className, id: title, ref: intersectionRef },
        ...
        react_1["default"].createElement("div", { className: utils_1.cn('grid grid-cols-3 gap-[50px]', listClassName) }, items.map(function (product) { return (react_1["default"].createElement(index_1.ProductCard, { key: product.id, id: product.id, name: product.name, imageUrl: product.imageUrl, price: product.items[0].price, ingredients: product.ingredients })); }))));
};
