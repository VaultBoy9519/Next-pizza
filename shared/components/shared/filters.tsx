		...
		<div className={className}>
			...
			<div className='mt-5 border-y border-y-neutral-100 py-6 pb-7'>
				...
				<div className='flex gap-3 mb-5'>
					<Input type='number' placeholder='0' min={0} max={30000} onChange={e => filters.setPrices('priceFrom', Number(e.target.value))} value={String(priceFrom)} />
					<Input type='number' placeholder='30000' min={100} max={30000} onChange={e => filters.setPrices('priceTo', Number(e.target.value))} value={String(priceTo)} />
				</div>
