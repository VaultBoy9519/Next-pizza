...
exports.ChooseProductModal = function (_a) {
    ...
    var onAddPizza = function (productItemId, ingredients) {
        addCartItem({
    ...
    return (react_1["default"].createElement(dialog_1.Dialog, { open: Boolean(product), onOpenChange: function () { return router.back(); } },
        react_1["default"].createElement(dialog_1.DialogContent, { className: utils_1.cn('p-0 w-[1060px] max-w-[1060px] min-h-[550px] bg-white overflow-hidden', className) }, isPizzaForm ? (react_1["default"].createElement(choose_pizza_form_1.ChoosePizzaForm, { onClickAddCart: onAddPizza, name: name, items: product.items, imageUrl: imageUrl, ingredients: product.ingredients })) : (react_1["default"].createElement(choose_product_form_1.ChooseProductForm, { onSubmit: onAddProduct, name: name, price: firstItem.price, imageUrl: imageUrl })))));
};
