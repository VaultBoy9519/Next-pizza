...
exports.ChooseProductModal = function (_a) {
    ...
    return (react_1["default"].createElement(dialog_1.Dialog, { open: Boolean(product), onOpenChange: function () { return router.back(); } },
        react_1["default"].createElement(dialog_1.DialogContent, { className: utils_1.cn('p-0 w-[1060px] max-w-[1060px] min-h-[500px] bg-white overflow-hidden', className) }, isPizzaForm ? react_1["default"].createElement(choose_pizza_form_1.ChoosePizzaForm, { name: name, imageUrl: imageUrl }) : react_1["default"].createElement(choose_product_form_1.ChooseProductForm, { name: name, imageUrl: imageUrl }))));
};
